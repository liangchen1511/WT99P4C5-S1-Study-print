...
lv_label_set_text(ui_LabelPanelScreenSettingBLESwitch,"蓝牙");
lv_obj_set_style_text_font(ui_LabelPanelScreenSettingBLESwitch, &lv_font_ui_zh_30, LV_PART_MAIN| LV_STATE_DEFAULT);
