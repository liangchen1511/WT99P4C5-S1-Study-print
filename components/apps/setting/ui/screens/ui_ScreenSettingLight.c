...
lv_label_set_text(ui_LabelPanelScreenSettingLightSwitch,"亮度");
lv_obj_set_style_text_font(ui_LabelPanelScreenSettingLightSwitch, &lv_font_ui_zh_30, LV_PART_MAIN| LV_STATE_DEFAULT);
