...
lv_label_set_text(ui_LabelPanelScreenSettingVolumeSwitch,"音量");
lv_obj_set_style_text_font(ui_LabelPanelScreenSettingVolumeSwitch, &lv_font_ui_zh_30, LV_PART_MAIN| LV_STATE_DEFAULT);
